...
| Aritmética de curva en sus casos límite | `is_on_curve(None)`, escalar negativo | El punto del servidor pasa por la comprobación *on-curve* **antes** de la aritmética; el punto en el infinito y los escalares negativos no los produce nadie |
